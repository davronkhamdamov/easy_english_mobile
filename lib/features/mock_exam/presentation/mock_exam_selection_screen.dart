          ...
          IconButton(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Viewing past exam performance history.')),
              );
            },
          ),
        ],
          ...
          children: [
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      const Icon(Icons.timer_outlined, color: Colors.white70, size: 24),
                    ],
                  ),
            ...
            _buildPaperItem(
              ...
              paper: MockExamPaper(
                ...
                description: 'Advanced passage difficulty featuring high-frequency C1 collocations.',
                difficulty: 'Hard',
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text('Start Writing Test Engine', style: TextStyle(color: Colors.white)),
              ),
            ],
          ),
        );
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text('Start Speaking Simulation', style: TextStyle(color: Colors.white)),
              ),
            ],
          ),
        );
