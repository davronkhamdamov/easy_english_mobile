...
class _MockResultScreenState extends State<MockResultScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final accuracyPct = totalQs > 0 ? (correctCount / totalQs * 100).toStringAsFixed(1) : '0.0';
    ...
    final filteredQuestions = res.allQuestions.where((q) {
      ...
      if (_selectedFilter == 'Correct') {
        return userAns.isNotEmpty && (userAns == correctAns || correctAns.contains(userAns));
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Mock Exam Performance Report', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        elevation: 0,
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                _buildSubScoreCard(
                  ...
                  rawRatio: '${res.readingRawScore}/${res.totalReadingQuestions > 0 ? res.totalReadingQuestions : 40}',
                ...
                _buildSubScoreCard(
                  ...
                  rawRatio: '${res.listeningRawScore}/${res.totalListeningQuestions > 0 ? res.totalListeningQuestions : 40}',
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  _statItem('Time Taken', _formatTimeTaken(res.timeTakenSeconds), Icons.timer_outlined, AppColors.primary),
                  _statItem('Accuracy', '$accuracyPct%', Icons.pie_chart_outline, AppColors.success),
                  _statItem('Correct', '$correctCount/$totalQs', Icons.check_circle_outline, AppColors.secondary),
                ],
              ),
            ),
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: ['All', 'Correct', 'Incorrect', 'Unanswered'].map((f) {
