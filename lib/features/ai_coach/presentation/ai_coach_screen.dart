...
/// Powered by Google Antigravity SDK Agent & Django DRF analytics aggregation.
...
class _AICoachScreenState extends State<AICoachScreen> {
  ...
  final Map<String, dynamic> _coachData = {
    'predicted_overall_band': 7.0,
    'target_band': 7.5,
    'weakness_summary': [
      'Task 2 Complex Grammatical Range & Passive Voice',
      'Listening Section 3 Academic Multiple Choice',
      'Advanced C1 Synonyms in Writing'
    ],
    'remediation_tasks': [
      'Complete 1 Sentence Builder exercise on "Conditionals"',
      'Review 5 C1 Academic Flashcards (Per-meaning SM-2)',
      'Listen to 1 Short Academic Podcast segment & extract vocabulary'
    ],
    'ai_coach_notes':
        'Awesome progress! Your Speaking Part 1 fluency score rose to Band 7.5 this week. Let\'s polish your Task 2 writing structure next to reach your 7.5 Target Band!'
  };
