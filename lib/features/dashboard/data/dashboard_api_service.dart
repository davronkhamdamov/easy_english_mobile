...
class DashboardApiService {
  Future<LearningPathResponse> fetchLearningPathToday() async {
      ...
      todayPlan: DailyPlan(
        ...
        tasks: const [
          ...
          DailyTask(
            ...
            description: 'Complete interactive exercises targeting 3rd and mixed conditionals.',
            durationMinutes: 10,
          ...
          DailyTask(
            ...
            description: 'Draft an academic essay response & evaluate with AI Band Examiner.',
            durationMinutes: 10,
          ...
          DailyTask(
            ...
            description: 'Construct advanced complex sentences using active target vocabulary.',
            durationMinutes: 5,
      ...
      tomorrowPlan: DailyPlan(
        ...
        tasks: const [
          DailyTask(
            ...
            description: 'Learn 10 new high-frequency IELTS academic collocations.',
            durationMinutes: 10,
          ...
          DailyTask(
            ...
            description: 'Record 2-minute response & get instant AI pronunciation and lexical feedback.',
            durationMinutes: 10,
          ...
          DailyTask(
            ...
            description: 'Solve passage exercises focusing on True/False/Not Given statement differentiation.',
            durationMinutes: 15,
  ...
  Future<AchievementMotivationOverview> fetchMotivationOverview() async {
    await Future.delayed(const Duration(milliseconds: 250));
    ...
    final weeklyBreakdown = List.generate(7, (index) {
      ...
      final isToday = d.year == todayDate.year && d.month == todayDate.month && d.day == todayDate.day;
    ...
    return AchievementMotivationOverview(
      ...
      motivationalCards: const [
        MotivationalCard(
          ...
          message: 'Consistency is the #1 predictor of scoring Band 7.5+. You are building mastery every single day.',
        ...
        MotivationalCard(
          ...
          message: 'You have 1 Streak Freeze shield available. Missed days won\'t reset your hard-earned progress.',
        ...
        MotivationalCard(
          ...
          message: '"Do not memorize canned answers. Focus on natural cohesion, precise vocabulary, and accurate grammar."',
