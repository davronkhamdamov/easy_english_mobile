...
class _DSBadgePageState extends State<DSBadgePage> {
  ...
  int _selectedIconIndex =
      1; // 0: None, 1: Check, 2: Star, 3: Warning, 4: Flame, 5: Lock
  ...
  Widget build(BuildContext context) {
    return ComponentPageWrapper(
      title: 'DSBadge',
      subtitle:
          'Compact status pill badge component with solid & outlined variants across 5 color tokens',
      category: 'Components',
          ...
          child: Column(
            ...
            children: [
              ...
              DSInput(
                ...
                onChanged: (val) =>
                    setState(() => _badgeLabel = val.isEmpty ? 'Badge' : val),
              ),
              AppSpacing.gapVerticalMd,
              ...
              Wrap(
                ...
                children: [
                  ChoiceChip(
                    ...
                    onSelected: (_) => setState(() => _selectedIconIndex = 0),
                  ),
                  ChoiceChip(
                    label: const Text('Check'),
                    selected: _selectedIconIndex == 1,
                    onSelected: (_) => setState(() => _selectedIconIndex = 1),
                  ),
                  ChoiceChip(
                    label: const Text('Star'),
                    selected: _selectedIconIndex == 2,
                    onSelected: (_) => setState(() => _selectedIconIndex = 2),
                  ),
                  ChoiceChip(
                    label: const Text('Warning'),
                    selected: _selectedIconIndex == 3,
                    onSelected: (_) => setState(() => _selectedIconIndex = 3),
                  ),
                  ChoiceChip(
                    label: const Text('Flame'),
                    selected: _selectedIconIndex == 4,
                    onSelected: (_) => setState(() => _selectedIconIndex = 4),
                  ),
                  ChoiceChip(
                    label: const Text('Lock'),
                    selected: _selectedIconIndex == 5,
                    onSelected: (_) => setState(() => _selectedIconIndex = 5),
                  ),
                ],
              ),
              AppSpacing.gapVerticalMd,
              ...
              SwitchListTile(
                ...
                subtitle: const Text(
                  'Transparent background with thin colored border stroke',
                ),
                value: _isOutlined,
  ...
  Widget _buildMatrix(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          'Solid background vs Outlined background across all status variants.',
        ...
        DSCard(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Outlined Stroke Badges (isOutlined = true)',
                style: AppTypography.h3.copyWith(
                  color: isDark
                      ? AppColors.darkTextPrimary
                      : AppColors.lightTextPrimary,
          ...
          children: [
            ...
            DSButton(
              ...
              onPressed: () {
                DSSnackbar.show(
                  context,
                  message: 'Badge code copied to clipboard!',
  ...
  Widget _buildSpecs(BuildContext context) {
    ...
    final props = [
      ...
      },
      {
        ...
        'default': 'primary',
        'desc':
            'Color token theme: primary, success, warning, danger, neutral.',
      },
      {
        'name': 'isOutlined',
        'type': 'bool',
        'default': 'false',
        'desc': 'If true, renders with transparent background and thin border.',
      },
      {
        'name': 'icon',
        'type': 'Widget?',
        'default': 'null',
        'desc': 'Optional icon widget leading the text label.',
      },
    ];
