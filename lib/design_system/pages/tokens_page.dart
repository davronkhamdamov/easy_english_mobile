...
class _DSTokensPageState extends State<DSTokensPage> {
  ...
  Widget build(BuildContext context) {
    return ComponentPageWrapper(
      title: 'Design Tokens',
      subtitle:
          'Color palettes, typography scale, spacing rules, shadows & animation tokens',
      category: 'Foundation',
  ...
  Widget _buildColorPalette(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          'Click any color tile to copy its HEX value.',
        ...
        // Theme Surfaces
        Text(
          'Surface & Border Tokens (${isDark ? "Dark Theme Active" : "Light Theme Active"})',
          style: AppTypography.h3.copyWith(
            color: isDark
                ? AppColors.darkTextPrimary
                : AppColors.lightTextPrimary,
  ...
  Widget _buildTypographyScale(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        AppSpacing.gapVerticalSm,
        Text(
          'Preview typography hierarchy with custom sample text.',
          style: AppTypography.bodyMd.copyWith(
            color: isDark
                ? AppColors.darkTextSecondary
                : AppColors.lightTextSecondary,
        ...
        DSInput(
          ...
          onChanged: (val) => setState(
            () => _sampleTypographyText = val.isEmpty ? 'Sample Text' : val,
          ),
        ),
        AppSpacing.gapVerticalLg,
              ...
              return Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(child: Text(_sampleTypographyText, style: style)),
                  ],
                ),
              );
            }).toList(),
  ...
  Widget _buildShadowsAndAnimations(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            _buildShadowBox(
              isDark,
              'Primary Glow',
              AppShadows.glow(AppColors.primary, blurRadius: 16),
            ),
            _buildShadowBox(
              isDark,
              'Danger Glow',
              AppShadows.glow(AppColors.danger, blurRadius: 16),
            ),
          ],
        ),
        ...
        AppSpacing.gapVerticalLg,
        Text(
          'Micro-Animations Timings & Curves',
          style: AppTypography.h2.copyWith(
            color: isDark
                ? AppColors.darkTextPrimary
                : AppColors.lightTextPrimary,
          ...
          child: Column(
            children: [
              _buildAnimRow(
                ...
                '150 ms',
                'Curves.easeOutCubic',
                'Instant hover scale & button tap feedback',
              ),
              const Divider(),
              _buildAnimRow(
                'normal',
                ...
                'Color transitions & expansion panels',
              ),
              const Divider(),
              _buildAnimRow(
                'slow',
                '500 ms',
                'Curves.easeOutBack',
                'Modal entry spring animations & page transitions',
              ),
            ],
          ),
        ),
