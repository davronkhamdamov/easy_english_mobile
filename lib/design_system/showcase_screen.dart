...
class _DSShowcaseScreenState extends State<DSShowcaseScreen> {
        ...
        return Scaffold(
          appBar: AppBar(
            leading: IconButton(
              ...
              onPressed: () =>
                  setState(() => _activePage = ShowcasePage.overview),
            ),
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                _buildSectionHeader(
                  '2.1 Button Components (DSButton)',
                ...
                _buildSectionHeader(
                  '2.3 Card Container Components (DSCard)',
                ...
                _buildSectionHeader(
                  '2.4 Badges & Overlays (DSBadge, DSSnackbar, DSDialog)',
  ...
  Widget _buildNavigationHubCard(bool isDark) {
    final navItems = [
      {
        'page': ShowcasePage.apiDebugger,
        'title': 'API Call Inspector',
        'desc': 'Real-time Network Logger • cURL • Headers • Payload',
        'icon': Icons.api_rounded,
        'color': AppColors.primary,
      },
      {
        'page': ShowcasePage.login,
        'title': 'Login Screen',
        'desc': 'Full Auth Flow • Vector Hero • Social Pills',
        'icon': Icons.lock_open_rounded,
        'color': AppColors.accentGreenDark,
      },
      {
        'page': ShowcasePage.button,
        'title': 'DSButton',
        'desc': '5 Variants • 3 Sizes • Animations',
        'icon': Icons.smart_button_rounded,
        'color': AppColors.primary,
      },
      {
        'page': ShowcasePage.input,
        'title': 'DSInput',
        'desc': 'Text • Password • Email • Search',
        'icon': Icons.input_rounded,
        'color': AppColors.secondary,
      },
      {
        'page': ShowcasePage.card,
        'title': 'DSCard',
        'desc': 'Elevated • Outlined • Glassmorphism',
        'icon': Icons.crop_portrait_rounded,
        'color': AppColors.success,
      },
      {
        'page': ShowcasePage.badge,
        'title': 'DSBadge',
        'desc': 'Pills • Status Colors • Outlined',
        'icon': Icons.stars_rounded,
        'color': AppColors.warning,
      },
      {
        'page': ShowcasePage.snackbar,
        'title': 'DSSnackbar',
        'desc': 'Success • Warning • Danger • Info',
        'icon': Icons.notifications_active_rounded,
        'color': AppColors.danger,
      },
      {
        'page': ShowcasePage.dialog,
        'title': 'DSDialog',
        'desc': 'Glass Modal • Backdrop Blur',
        'icon': Icons.open_in_new_rounded,
        'color': AppColors.primaryHover,
      },
      {
        'page': ShowcasePage.tokens,
        'title': 'Design Tokens',
        'desc': 'Colors • Typography • Shadows',
        ...
        children: [
          Wrap(
            ...
            children: [
              ...
              const DSBadge(
                label: '7 DEDICATED PAGES AVAILABLE',
    ...
    return DSCard(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'H2 Subsection Header (20px W600)',
            style: AppTypography.h2.copyWith(
              color: isDark
                  ? AppColors.darkTextPrimary
                  : AppColors.lightTextPrimary,
          ...
          Text(
            'Body Medium (16px Regular) — Clean legible typography hierarchy.',
          ...
          Wrap(
            ...
            children: [
              DSButton(
                ...
                onPressed: () => _showActionToast('Primary clicked'),
              ),
              DSButton(
                text: 'Secondary',
                ...
                isLoading: _globalLoading,
                disabled: _globalDisabled,
                onPressed: () => _showActionToast('Secondary clicked'),
              ),
              DSButton(
                text: 'Outline',
                ...
                isLoading: _globalLoading,
                disabled: _globalDisabled,
                onPressed: () => _showActionToast('Outline clicked'),
              ),
              DSButton(
                text: 'Ghost',
                variant: DSButtonVariant.ghost,
                isLoading: _globalLoading,
                disabled: _globalDisabled,
                onPressed: () => _showActionToast('Ghost clicked'),
              ),
              DSButton(
                text: 'Danger',
                ...
                isLoading: _globalLoading,
                disabled: _globalDisabled,
                onPressed: () => _showActionToast('Danger clicked'),
              ),
            ],
          ),
        ],
          ...
          Wrap(
            ...
            children: [
              DSButton(
                text: 'Small (sm)',
                size: DSButtonSize.sm,
                leftIcon: const Icon(Icons.flash_on),
                onPressed: () {},
              ),
              DSButton(
                text: 'Medium (md)',
    ...
    return Wrap(
      ...
      children: [
        DSCard(
          ...
          body: Text(
            'Elevated surface with smooth ambient shadow and hover lift animation.',
        ...
        DSCard(
          ...
          body: Text(
            'Clean flat border container with subtle hover border highlight.',
            style: AppTypography.bodySm.copyWith(
              color: isDark
                  ? AppColors.darkTextSecondary
                  : AppColors.lightTextSecondary,
              ...
              Row(
                children: [
                  DSButton(
                    ...
                    size: DSButtonSize.sm,
                    onPressed: () =>
                        setState(() => _activePage = ShowcasePage.badge),
                  ),
                  DSButton(
                    text: 'Snackbar Page →',
                    variant: DSButtonVariant.ghost,
                    size: DSButtonSize.sm,
                    onPressed: () =>
                        setState(() => _activePage = ShowcasePage.snackbar),
                  ),
                  DSButton(
                    text: 'Dialog Page →',
                    variant: DSButtonVariant.ghost,
                    size: DSButtonSize.sm,
                    onPressed: () =>
                        setState(() => _activePage = ShowcasePage.dialog),
                  ),
                ],
              ),
            ],
              ...
              DSButton(
                ...
                onPressed: () {
                  DSDialog.show(
                    ...
                    message:
                        'This interactive dialog features smooth backdrop blur and scale-in spring micro-animation.',
              ...
              DSButton(
                ...
                onPressed: () {
                  DSSnackbar.show(
                    ...
                    message:
                        'Design system components rendered cleanly with zero errors!',
  ...
  void _showActionToast(String message) {
    DSSnackbar.show(context, message: message, variant: DSSnackbarVariant.info);
  }
}
